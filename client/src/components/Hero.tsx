      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Button
            ...
            className="bg-primary/90 text-primary-foreground backdrop-blur-sm min-w-[200px] btn-lift text-lg"
          ...
          <Button
            ...
            className="bg-white/10 text-white border-white/30 backdrop-blur-sm min-w-[200px] btn-lift text-lg"
