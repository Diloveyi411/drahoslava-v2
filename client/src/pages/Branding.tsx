...
const WORK = [
  {
    ...
    testimonialPhoto: '/portfolio/tina/tina.jpg',
    ...
    gallery: [
      { src: '/portfolio/tina/brand-kit.jpg', title: 'Brand Kit', caption: 'Visual identity and direction' },
      { src: '/portfolio/tina/overview.jpg', title: 'Brand System', caption: 'Applied across touchpoints' },
      { src: '/portfolio/tina/carousel-1.jpg', title: 'Visual Direction', caption: 'Content direction in use' },
      { src: '/portfolio/tina/templates.jpg', title: 'Templates', caption: 'Brand applied consistently' },
    ],
  },
  {
    ...
    gallery: [
      { src: '/portfolio/lubka/brand-kit.jpg', title: 'Brand Kit', caption: 'Color, typography, identity system' },
      { src: '/portfolio/lubka/vizitka-front.jpg', title: 'Business Card Front', caption: 'Serif wordmark, warm gold accent' },
      { src: '/portfolio/lubka/vizitka-back.jpg', title: 'Business Card Back', caption: 'Tagline: Vráťte sa späť k sebe' },
      { src: '/portfolio/lubka/home.jpg', title: 'Website: Home', caption: 'laskavydotyk.com' },
      { src: '/portfolio/lubka/about.jpg', title: 'Website: O mne', caption: 'Personal story, human tone' },
      { src: '/portfolio/lubka/services.jpg', title: 'Website: Služby', caption: 'Four treatments, clear pricing' },
      { src: '/portfolio/lubka/contact.jpg', title: 'Website: Kontakt', caption: 'Simple booking by phone or email' },
      { src: '/portfolio/lubka/detail.jpg', title: 'Website: Detail', caption: 'Service detail view' },
    ],
  },
  {
    title: 'DearDreams',
    ...
    gallery: [
      { src: '/portfolio/deardreams/concept-bold.jpg', title: 'The Bold Transformation', caption: '"NOT PRETTY. POWERFULL."' },
      { src: '/portfolio/deardreams/concept-bold-full.jpg', title: 'Bold Direction', caption: 'Full brand concept', objectPosition: 'top' },
      { src: '/portfolio/deardreams/concept-soft-full.jpg', title: 'The Soft Evolution', caption: 'Girl to woman', objectPosition: 'top' },
      { src: '/portfolio/deardreams/before-brand.jpg', title: 'Before', caption: 'Cute, pastel, daisy-coded' },
      { src: '/portfolio/deardreams/audit-strategy.jpg', title: 'Brand Audit', caption: 'Strategic direction: 4 pillars identified' },
      { src: '/portfolio/deardreams/brand-system.jpg', title: 'Brand System', caption: 'Color, typography, spacing, voice' },
    ],
  },
];
    ...
    >
      ...
      {work.testimonial && (
        <div style={{ marginTop: m ? 40 : 56, borderLeft: `2px solid ${accent}`, paddingLeft: m ? 20 : 32 }}>
          ...
          <p style={{ fontFamily: 'Urbanist', fontWeight: 300, fontSize: m ? 17 : 20, lineHeight: 1.75, color: 'rgba(237,237,234,0.6)', fontStyle: 'italic', margin: '0 0 20px' }}>
            "{work.testimonial}"
          </p>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            {work.testimonialPhoto && (
              <img src={work.testimonialPhoto} alt={work.title} style={{ width: 40, height: 40, borderRadius: '50%', objectFit: 'cover', border: `1px solid ${accent}40` }} />
            )}
