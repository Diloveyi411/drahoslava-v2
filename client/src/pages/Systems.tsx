...
const WORK = [
  {
    ...
    gallery: [
      ...
      { src: '/portfolio/polystate-ux/onboarding.jpg', title: 'Onboarding Flow', caption: '3-step wizard for first-time users', contain: true },
    ],
  },
  {
    title: 'WebTrigo',
  ...
  },
  {
    ...
    gallery: [
      { src: '/portfolio/is-justice/after-hero.jpg', title: 'Hero — After', caption: 'BW before/after photography, gradient CTA, clear headline', contain: true },
      { src: '/portfolio/is-justice/before-hero.jpg', title: 'Hero — Before', caption: 'Beige background, generic headline, no visual impact', contain: true },
      { src: '/portfolio/is-justice/after-comparison.jpg', title: 'Comparison Section', caption: 'Dark section: traditional approach vs. IS Justice', contain: true },
      { src: '/portfolio/is-justice/after-sluzby.jpg', title: 'Services — Bento Grid', caption: '7 services in asymmetric bento layout', contain: true },
      { src: '/portfolio/is-justice/before-sluzby.jpg', title: 'Services — Before', caption: 'Orange cards with heavy icons, no hierarchy', contain: true },
      { src: '/portfolio/is-justice/after-cennik.jpg', title: 'Pricing', caption: 'Transparent pricing: 3 tiers + addons', contain: true },
      { src: '/portfolio/is-justice/after-podnikatelia.jpg', title: 'PathSelector', caption: 'Emotional copy: client pain before solution', contain: true },
      { src: '/portfolio/is-justice/after-footer.jpg', title: 'Footer', caption: 'Dark, structured, complete contact info', contain: true },
      { src: '/portfolio/is-justice/before-kontakt.jpg', title: 'Contact — Before', caption: 'Map + scattered info, no visual system', contain: true },
    ],
  },
  {
    title: 'Amagi Labs',
    ...
    gallery: [
      { src: '/portfolio/amagi-labs/after-hero.jpg', title: 'Hero: After', caption: 'Editorial visual, direct headline, clear subheadline', contain: true },
      { src: '/portfolio/amagi-labs/before-hero.jpg', title: 'Hero: Before', caption: 'Rainbow gradient text, no visual anchor, vague headline "Web 3 Mobility"', contain: true },
      { src: '/portfolio/amagi-labs/after-services-intro.jpg', title: 'Services: After', caption: 'Audience segmentation: startups, funds, institutions', contain: true },
      { src: '/portfolio/amagi-labs/after-services-grid.jpg', title: 'Services Grid', caption: 'Clean 4-card layout, no decorative noise', contain: true },
      { src: '/portfolio/amagi-labs/before-services.jpg', title: 'Services: Before', caption: 'Dark red cards with decorative icons and checkmarks, cluttered background', contain: true },
      { src: '/portfolio/amagi-labs/after-clients.jpg', title: 'Clients: After', caption: 'Carousel with named partnerships and descriptions', contain: true },
      { src: '/portfolio/amagi-labs/before-clients.jpg', title: 'Clients: Before', caption: 'Logo strip with no context or weight', contain: true },
      { src: '/portfolio/amagi-labs/after-about.jpg', title: 'Managing Partner', caption: 'Human layer: David Stancel, 10+ years in crypto', contain: true },
      { src: '/portfolio/amagi-labs/after-footer.jpg', title: 'Footer: After', caption: 'Clean CTA section with contact details', contain: true },
      { src: '/portfolio/amagi-labs/before-footer.jpg', title: 'Footer: Before', caption: 'Minimal footer, scattered contact info, no visual system', contain: true },
    ],
  },
  {
    ...
    gallery: [
      { src: '/portfolio/lubka/home.jpg', title: 'Homepage', caption: '"Vráťte sa späť k sebe"', contain: true },
      { src: '/portfolio/lubka/about.jpg', title: 'About', caption: 'Warm, personal, clear', contain: true },
      { src: '/portfolio/lubka/services.jpg', title: 'Brand Voice', caption: 'Quote section', contain: true },
      { src: '/portfolio/lubka/contact.jpg', title: 'Services 1/2', caption: 'Structured for clarity and action', contain: true },
      { src: '/portfolio/lubka/mobile.jpg', title: 'Services 2/2', caption: 'Responsive layout', contain: true },
      { src: '/portfolio/lubka/detail.jpg', title: 'Footer', caption: 'Services and footer', contain: true },
