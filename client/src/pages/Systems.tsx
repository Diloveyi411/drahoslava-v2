    ...
    <div style={{ background: '#07070D', minHeight: '100vh', color: '#EDEDEA' }}>
      ...
      >
        ...
        >
          ...
          >
            10+ years fixing how people and systems break
          </motion.h2>
          ...
          >
            I started in operations — managing clinics, coordinating teams, building workflows in high-pressure environments. I wasn't designing interfaces, but I kept asking: Why does this confuse people? Why do they skip this step? What would make this obvious to them?
          </motion.p>
          ...
          >
            That's what led me into UX. I studied psychology and work with visual structure. Both trained me to read how things are perceived before they're understood. Creativity and structure aren't opposites — I use both to remove confusion from products. I turn complex systems into clear decisions that drive action.
          </motion.p>
          ...
          >
            {[
              'Psychology · Paneurópska vysoká škola',
              'Operations · healthcare & digital systems',
              ...
              <React.Fragment key={cred}>
                ...
                {i < arr.length - 1 && (
                  <span style={{ color: 'rgba(237,237,234,0.15)', fontSize: 13 }}>·</span>
                )}
              </React.Fragment>
            ))}
          </motion.div>
