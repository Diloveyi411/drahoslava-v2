...
const WORK = [
  {
    ...
    gallery: [
      { src: '/portfolio/polystate/slides.jpg', title: 'Posts Series', caption: '40+ slides across 5 series' },
      { src: '/portfolio/polystate/overview.jpg', title: 'Social Media System', caption: 'Full system overview' },
      { src: '/portfolio/polystate/carousel.jpg', title: 'Carousel Series', caption: 'Information hierarchy in action' },
      { src: '/portfolio/polystate/detail.jpg', title: 'Content Detail', caption: 'Structure and hierarchy' },
  ...
  },
  {
    ...
    gallery: [
      { src: '/portfolio/tina/overview.jpg', title: 'Content System', caption: 'Full system overview' },
      { src: '/portfolio/tina/content-system.jpg', title: 'Full System', caption: 'Carousels, guide, and promo' },
      { src: '/portfolio/tina/brand-kit.jpg', title: 'Brand Kit', caption: 'Visual identity and direction' },
      { src: '/portfolio/tina/carousel-1.jpg', title: 'Carousels', caption: 'User-focused messaging' },
    ],
  },
];
    ...
    <div style={{ background: '#07070D', minHeight: '100vh', color: '#EDEDEA' }}>
      ...
      >
        ...
        <div style={{ display: 'grid', gridTemplateColumns: m ? '1fr' : '1fr 1fr', gap: m ? 16 : 20, maxWidth: 800 }}>
          {[
            'You know what to say but not how to make it land consistently.',
            'Your content is sporadic because there is no system behind it.',
            'You are building a brand and social is part of the story.',
      ...
      >
        ...
        <div style={{ display: 'grid', gridTemplateColumns: m ? '1fr' : 'repeat(3, 1fr)', gap: m ? 20 : 32, maxWidth: 680, marginBottom: 40 }}>
          {[
            { n: '01', label: 'You send a message', sub: 'Tell me about the brand and what is not working.' },
            ...
            <div key={s.n}>
              <p style={{ fontFamily: 'Urbanist', fontWeight: 300, fontSize: 11, letterSpacing: 3, color: '#B8C0FF', textTransform: 'uppercase', margin: '0 0 8px' }}>{s.n}</p>
        ...
        <QuickContactForm accent="#B8C0FF" />
      </motion.div>
